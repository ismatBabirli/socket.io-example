...
window.Echo.channel('test-event').listen('.message.test', function (e) {
  console.log(e);
}); // window.Echo.private('private-event').listen('.message.private', (e) => {
...
__webpack_require__(/*! /home/iron/Documents/projects/ismat/Demo/socket/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/iron/Documents/projects/ismat/Demo/socket/resources/sass/app.scss */"./resources/sass/app.scss");
